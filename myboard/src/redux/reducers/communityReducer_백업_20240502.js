            ...
            return {
                ...
                replys: [
                    ...state.replys,
                    {
                        ...
                        "up_reply_code": action.payload.BOARD_ID,
                        "level": 1,
...
*/
export function saveNewReply(board_id, up_reply_code, level, content) {
...
*/
export function deleteReplyByOneCode(board_id, reply_code, level, P_LV1_IDX, P_LV2_IDX, P_LV3_IDX, P_LV4_IDX) {
